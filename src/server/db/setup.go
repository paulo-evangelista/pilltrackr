...
func SetupPostgres() *gorm.DB {
	...
	dsn := fmt.Sprintf("host=%s user=username password=password dbname=postgres port=5432 sslmode=disable TimeZone=America/Sao_Paulo", dbHost)
	...
	err = dbClient.AutoMigrate(&ItemType{})
	if err != nil {
